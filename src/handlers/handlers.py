from handlers.case_handler import (
    ...
    handle_weight,
    handle_increase_reward,  # NEW HANDLER
    handle_edit_case,        # NEW HANDLER
)
...
start_handler = ConversationHandler(
    ...
    states={
        ...
        State.CREATE_CASE_ASK_REWARD: [
            ...
            CallbackQueryHandler(handle_increase_reward, pattern="^increase_reward$"),  # NEW HANDLER
            CallbackQueryHandler(
        ...
        State.CREATE_CASE_CONFIRM_TRANSFER: [
            CallbackQueryHandler(
                handle_transfer_confirmation,
                pattern="^(confirm_transfer|cancel_transfer|edit_case)$",  # ADDED EDIT_CASE
            )
        ],
        State.CASE_LIST: [
...
# ---------------------- Wallet Conversation Handler Start  ---------------------
