CASE_CONSTANT = {
    ...
    "ur": {
        # Existing Constants
        "create_case_title": "نیا معاملہ بنائیں",
        "enter_name": "براہ کرم اپنا نام درج کریں:",
        "disclaimer_2": (
            "ذمہ داری سے انکار 2:\n\n"
            "1. معاملہ حل ہونے تک انعام کی رقم محفوظ رہے گی۔\n"
            "2. اس سروس کا غلط استعمال ممنوع ہے۔\n"
            "3. تمام فراہم کردہ معلومات عوامی طور پر دیکھی جا سکیں گی۔\n\n"
        ...
        "enter_person_name": "براہ کرم اس شخص کا نام درج کریں جس کو آپ تلاش کر رہے ہیں:",
        "relationship": "آپ کا اس شخص سے کیا تعلق ہے؟ (مثلاً: دوست، خاندان، شریک حیات، وغیرہ):",
        "upload_photo": "اس شخص کی واضح تصویر اپ لوڈ کریں (زیادہ سے زیادہ 5MB):",
        "last_seen_location": "آخری بار یہ شخص کہاں دیکھا گیا تھا؟",
        ...
        "height": "اس شخص کی قد کتنی ہے؟ (سینٹی میٹر میں):",
        "weight": "اس شخص کا وزن کتنا ہے؟ (کلو گرام میں):",
        ...
        "reward_amount_confirmed": "آپ کا انعامی رقم {0} کامیابی کے ساتھ تصدیق ہو چکا ہے۔",
        "insufficient_balance_for_transfer": "ٹرانسفر کرنے کے لیے بیلنس کافی نہیں ہے۔ آپ کا موجودہ بیلنس {0} ہے۔",
        "transfer_successful": "ٹرانسفر کامیابی سے ہو گیا۔",
        "transfer_failed": "ٹرانسفر ناکام رہا، براہ کرم دوبارہ کوشش کریں۔",
        "transfer_error": "ٹرانسفر کے دوران کچھ خرابی ہوئی۔ براہ کرم دوبارہ کوشش کریں۔",
        "transfer_canceled": "ٹرانسفر منسوخ کر دیا گیا ہے۔",
        "invalid_confirmation": "غلط جواب۔ 'yes' یا 'no' سے تصدیق کریں۔",
        "enter_reason_for_finding": "براہ کرم اس شخص کو تلاش کرنے کی وجہ درج کریں۔",
        "case_submitted": "آپ کا معاملہ کامیابی سے جمع کر لیا گیا ہے۔",
        "case_completed": "آپ کا معاملہ مکمل ہو چکا ہے۔",
        "reward_amount_negative": "انعامی رقم منفی نہیں ہو سکتی۔",
        "male_option": "♂ مرد",
        "female_option": "♀ عورت",
        "other_option": "دیگر",
        "transaction_failed": "❌ <b>ٹران잭شن ناکام</b>\n\nانعامی رقم کے ٹرانسفر کے دوران کچھ خرابی۔ براہ کرم بعد میں دوبارہ کوشش کریں۔",
        "transfer_canceled": "❌ <b>ٹرانسفر منسوخ</b>\n\nآپ کی درخواست پر انعامی رقم کا ٹرانسفر منسوخ کر دیا گیا ہے۔",
        ...
        "no_photo_found": "کوئی تصویر نہیں ملی۔ براہ کرم درست تصویر فائل اپ لوڈ کریں۔",
        "case_not_found": "معاملہ نہیں ملا۔ براہ کرم دوبارہ کوشش کریں۔",
        ...
        "wallet_name_exists": "ایسا نام والا والیٹ پہلے ہی موجود ہے۔ براہ کرم دوسرا نام منتخب کریں۔",
        "wallet_create_details": (
            "✅ والیٹ بنایا گیا!\n"
            "نام: {name}\n"
    ...
    "ja": {
        # Existing Constants
        "create_case_title": "新規ケースを作成",
        "enter_name": "名前を入力してください:",
        "disclaimer_2": (
            "免責事項 2:\n\n"
            "1. 報酬金額はケース解決まで第三者管理下に保持されます。\n"
            "2. サービスの悪用は禁止されています。\n"
        ...
        "relationship": "あなたとその人の関係は？（例：友人、家族、パートナーなど）:",
        "upload_photo": "その人の明確な写真をアップロードしてください（最大5MB）:",
        "last_seen_location": "最後にその人が見かけた場所はどこですか？",
        "sex": "その人の性別は？（男性/女性）:",
        "age": "その人の年齢は？",
        "hair_color": "その人の髪の色は？（例：ブロンド、ブラウンなど）:",
        "eye_color": "その人の目の色は？（例：青、緑など）:",
        "height": "その人の身長は？（cm）:",
        "weight": "その人の体重は？（kg）:",
        ...
        "refresh_wallet_balance": "ウォレット残高を更新してください。",
        "reward_amount_confirmed": "報酬金額 {0} は確認済みです。",
        "insufficient_balance_for_transfer": "送金には残高が不足しています。現在の残高は {0} です。",
        "transfer_successful": "送金に成功しました。",
        "transfer_failed": "送金に失敗しました。再度お試しください。",
        "transfer_error": "送金処理中にエラーが発生しました。再度お試しください。",
        "transfer_canceled": "送金がキャンセルされました。",
        "invalid_confirmation": "無効な応答です。「yes」または「no」で確認してください。",
        "enter_reason_for_finding": "その人を探す理由を入力してください。",
        "case_submitted": "あなたのケースは正常に送信されました。",
        "case_completed": "あなたのケースは完了しました。",
        "reward_amount_negative": "報酬金額はマイナスにできません。",
        "male_option": "♂ 男性",
        "female_option": "♀ 女性",
        "other_option": "その他",
        "transaction_failed": "❌ <b>取引失敗</b>\n\n報酬の転送中に問題が発生しました。後でもう一度お試しください。",
        "transfer_canceled": "❌ <b>送金キャンセル</b>\n\nご依頼により報酬送金はキャンセルされました。",
        ...
        "wallet_name_exists": "この名前のウォレットはすでに存在しています。他の名前を選択してください。",
        "wallet_create_details": (
            "✅ ウォレットが作成されました！\n"
            "名前: {name}\n"
    ...
    "ko": {
        # Existing Constants
        "create_case_title": "새로운 케이스 생성",
        "enter_name": "이름을 입력하세요:",
        "disclaimer_2": (
            "면책사항 2:\n\n"
            "1. 보상금은 케이스가 해결될 때까지 에스크로에 보관됩니다.\n"
            "2. 서비스의 악용은 금지되어 있습니다.\n"
            "3. 제공된 모든 정보는 공개됩니다.\n\n"
            "동의하시겠습니까?"
        ),
        "mobile_number_doesnt_exist": "입력한 휴대전화 번호가 존재하지 않습니다. 다시 시도해 주세요.",
        "enter_person_name": "찾고 있는 사람의 이름을 입력하세요:",
        "relationship": "당신과 그 사람의 관계는 무엇입니까? (예: 친구, 가족, 파트너 등):",
        "upload_photo": "그 사람의 명확한 사진을 업로드 하세요 (최대 5MB):",
        "last_seen_location": "마지막으로 그 사람이 목격된 장소는 어디입니까?",
        "sex": "그 사람의 성별은 무엇입니까? (남성/여성):",
        "age": "그 사람의 나이는 몇 살입니까?",
        "hair_color": "그 사람의 머리카락 색상은 무엇입니까? (예: 백금, 갈색 등):",
        "eye_color": "그 사람의 눈 색상은 무엇입니까? (예: 파란색, 초록색 등):",
        "height": "그 사람의 키는 몇 cm입니까?",
        "weight": "그 사람의 몸무게는 몇 kg입니까?",
        ...
        "refresh_wallet_balance": "지갑 잔액을 새로고침하세요.",
        "reward_amount_confirmed": "보상금액 {0}이(가) 확인되었습니다.",
        "insufficient_balance_for_transfer": "송금에 필요한 잔액이 부족합니다. 현재 잔액: {0}",
        "transfer_successful": "송금 성공.",
        "transfer_failed": "송금 실패. 다시 시도해 주세요.",
        "transfer_error": "송금 처리 중 오류 발생. 다시 시도해 주세요.",
        "transfer_canceled": "송금이 취소되었습니다.",
        "invalid_confirmation": "잘못된 응답입니다. 'yes' 또는 'no'로 확인해 주세요.",
        "enter_reason_for_finding": "사람을 찾는 이유를 입력하세요.",
        "case_submitted": "케이스가 성공적으로 제출되었습니다.",
        "case_completed": "케이스가 완료되었습니다.",
        "reward_amount_negative": "보상금액은 음수가 될 수 없습니다.",
        "male_option": "♂ 남자",
        "female_option": "♀ 여자",
        "other_option": "기타",
        "transaction_failed": "❌ <b>거래 실패</b>\n\n보상 송금 중 문제가 발생했습니다. 나중에 다시 시도해 주세요.",
        "transfer_canceled": "❌ <b>송금 취소됨</b>\n\n요청에 따라 보상 송금이 취소되었습니다.",
        ...
        "no_photo_found": "사진을 찾을 수 없습니다. 유효한 이미지 파일을 업로드 해주세요.",
        "case_not_found": "케이스를 찾을 수 없습니다. 다시 시도해 주세요.",
        ...
        "wallet_name_exists": "이미 해당 이름의 지갑이 존재합니다. 다른 이름을 선택하세요.",
        "wallet_create_details": (
            "✅ 지갑 생성 성공!\n"
            "이름: {name}\n"
    ...
    "km": {
        ...
        "disclaimer_2": (
            "ការបដិសេធ​ទទួលខុសត្រូវ 2:\n\n"
            "1. ចំនួនប្រាក់រង្វាន់នឹងត្រូវរក្សាទុកក្នុង escrow រហូតដល់ករណីត្រូវបានដោះស្រាយ។\n"
            "2. ការប្រើប្រាស់សេវាកម្មនេះ​ក្នុង​ផ្លូវមិនសមរម្យ​គឺ​ត្រូវ​បាន​ហាមឃាត់។\n"
            "3. ព័ត៌មានទាំងអស់ដែលផ្តល់ជូននឹងត្រូវបានបង្ហាញជាសាធារណៈ។\n\n"
            "តើ​អ្នកយល់ព្រមទេ?"
        ),
        "mobile_number_doesnt_exist": "លេខទូរសព្ទដែលអ្នកបានបញ្ចូលមិនមានទេ។ សូមព្យាយាមម្តងទៀត។",
        "enter_person_name": "សូមបញ្ចូលឈ្មោះរបស់បុគ្គលដែលអ្នកកំពុងស្វែងរក:",
        "relationship": "តើអ្នកមានទំនាក់ទំនងយ៉ាងដូចម្តេចជាមួយបុគ្គលនោះ? (ឧទាហរណ៍: មិត្តភក្ដិ, គ្រួសារ, ដៃគូ, ជាដើម):",
        "upload_photo": "ផ្ទុកឡើងនូវរូបថតច្បាស់លាស់របស់បុគ្គលនោះ (អតិបរមា 5MB):",
        "last_seen_location": "តើអ្នកបានឃើញបុគ្គលនោះជាមួយនៅទីណា?",
        "sex": "តើអ្នកដឹងពីភេទរបស់បុគ្គលនោះទេ? (បុរស/ស្ត្រី):",
        "age": "អាយុរបស់បុគ្គលនោះគឺប៉ុន្មាន?",
        "hair_color": "តើពណ៌សក់របស់បុគ្គលនោះគឺអ្វី? (ឧទាហរណ៍: ស, ខ្មៅ, ជាដើម):",
        "eye_color": "តើពណ៌ភ្នែករបស់បុគ្គលនោះគឺអ្វី? (ឧទាហរណ៍: ខៀវ, បៃតង, ជាដើម):",
        "height": "តើកំពស់របស់បុគ្គលនោះគឺប៉ុន្មាន? (cm):",
        "weight": "តើទម្ងន់របស់បុគ្គលនោះគឺប៉ុន្មាន? (kg):",
        "enter_valid_height": "សូមបញ្ចូលកំពស់ដែលមានសុពលភាព (cm)។",
        ...
        "refresh_wallet_balance": "សូមធ្វើការធ្វើបច្ចុប្បន្នភាពចំនួនប្រាក់កាបូបរបស់អ្នក។",
        "reward_amount_confirmed": "ចំនួនរង្វាន់ {0} ត្រូវបានបញ្ជាក់រួចរាល់។",
        "insufficient_balance_for_transfer": "ចំនួនប្រាក់មិនគ្រប់គ្រាន់សម្រាប់ធ្វើការផ្ទេរ។ ចំនួនប្រាក់បច្ចុប្បន្នគឺ {0}។",
        ...
        "invalid_confirmation": "ចម្លើយមិនត្រឹមត្រូវ។ សូមបញ្ជាក់ដោយប្រើ 'yes' ឬ 'no'។",
        "enter_reason_for_finding": "សូមបញ្ចូលហេតុផលសម្រាប់ការស្វែងរកបុគ្គលនោះ។",
        "case_submitted": "ករណីរបស់អ្នកត្រូវបានបញ្ជូនដោយជោគជ័យ។",
        "case_completed": "ករណីរបស់អ្នកត្រូវបានបញ្ចប់។",
        "reward_amount_negative": "ចំនួនរង្វាន់មិនអាចជាប្រាក់អវិជ្ជមានបានទេ។",
        "male_option": "♂ បុរស",
        "female_option": "♀ ស្ត្រី",
        "other_option": "ផ្សេងៗ",
        "transaction_failed": "❌ <b>បរាជ័យក្នុងការធ្វើប្រតិបត្តិការ</b>\n\nមានបញ្ហាកើតឡើងក្នុងការផ្ទេររង្វាន់។ សូមព្យាយាមម្តងទៀតក្រោយ។",
        "transfer_canceled": "❌ <b>ការផ្ទេរត្រូវបានបោះបង់</b>\n\nការផ្ទេររង្វាន់ត្រូវបានបោះបង់តាមតម្រូវការរបស់អ្នក។",
        ...
        "no_photo_found": "មិនឃើញរូបថត។ សូមផ្ទុករូបថតដែលមានសុពលភាពឡើងវិញ។",
        "case_not_found": "មិនឃើញករណី។ សូមព្យាយាមម្តងទៀត។",
